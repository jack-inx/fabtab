    ...
    $('#edit_user').submit(function(event) {
        ...
        $.ajax({
            ...
            success: function(data,textStatus,jqXHR){
                ...
                var div = "<div class='delete_dialog' style='margin-left: 69px ! important; margin-top: -335px ! important;'><div class='title' style='margin-left:15px;font-size:19px !important;margin-top:66px;'></div><div class='close234 close_dialog_offer'>X</div><div class='my_setting'>My Settings </div><div style='color: rgb(126, 190, 87); font-size: 23px; font-weight: normal; margin-left: 12px; margin-top: 83px;'>Save Successfully</div></div></br></br>";
